...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-12">
                        <h5><i class="mdi mdi-certificate"></i> PERIODE </h5>
                    </div>
                </div>    
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="background-color: #ffffff">
                ...
                <div class="modal-header">
                    <h5 class="modal-title mt-0"><i class="mdi mdi-plus-circle-outline"></i> Periode</h5>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #ffffff">
            ...
            <div class="modal-header">
                <h5 class="modal-title mt-0"><i class="fas fa-pencil-alt"></i> Cara Masuk</h5>
            </div>
...
<script id="text/javascript">
            ...
            success: function(result) {
                ...
                if (data.length) {
                    for (i = 0; i < data.length; i++) {
                        ...
                        tr.find('td:nth-child(3)').append('<div class="btn-group"><a href="javascript:;" class="btn btn-soft-warning btn-xs item_edit" data="'+data[i].periode_id+'"><i class="fas fa-pencil-alt"></i></a><a href="javascript:;" class="btn btn-soft-danger btn-xs item_delete" data="' + data[i].periode_id + '"><i class="far fa-trash-alt"></i></a></div>');
    ...
    $('#tabel_data').on('click','.item_edit',function(){
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('periode.edit') }}",
            dataType: "JSON",
            data: {id:id},
            success: function(data){

                $('#formModalEdit').modal('show');
                $('#formModalEdit').find('[name="id_edit"]').val(data.periode_id);
                $('#formModalEdit').find('[name="nama_edit"]').val(data.periode_nama);
